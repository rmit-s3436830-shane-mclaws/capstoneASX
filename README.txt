...
A Project by:
  ...
  Zac Williams (s3436170)
  Sonia Varghese (s3484881)

Documentation and source code for all aspects of the project are 
...
https://drive.google.com/file/d/0B4Cf2U-ZmwklcF9oWDB6ZkRRclE/view?usp=sharing
  ...
  Running the .JAR in command prompt (Windows) or Terminal (Linux/MacOS)
   with the argument "cmdLine" (eg. "java -jar TradingWheelsVersion1.jar cmdLine")
  will run the program with a command line interface, which includes
  all functionality.
